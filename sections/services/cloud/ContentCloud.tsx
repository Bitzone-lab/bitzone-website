...
export default function ContentCloud() {
    ...
    return (
        <section className="bg-white">
            <div className="xl:max-w-5xl xl:w-full xl:mx-auto xl:px-20">
                <div className="p-4 xl:flex xl:pt-32 xl:justify-between">
                    ...
                    <div className="xl:max-w-md xl:order-1 xl:pr-28">
                ...
                <div className="p-4 xl:flex xl:pt-32 xl:pb-32 xl:justify-between">
                    <div className="flex justify-center mb-6 mt-4 px-42">
                        <img src="/img/automation.svg" className="xl:w-96" />
                    </div>
                    <div className="xl:max-w-md xl:w-full xl:pl-28">
                        <h2 className="font-sofia-bold font-bold text-3xl text-subtle mb-6">
                            Automatización
                        </h2>
                        <p className="text-base font-light text-normal mb-7">
